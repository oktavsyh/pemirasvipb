<?php
    ...
    if(!isset($_SESSION['nim'])){
      ...
      exit();
        ...
        $sql = "SELECT * FROM paslon_bem_psdku";
...
<head>
    ...
    <title>Vote Calon Ketua BEM SV PSDKU IPB</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9 mx-auto">
              <h1 class="mb-12">Vote Calon Ketua BEM SV PSDKU</h1>
              <h2 class="mb-12"><?php
                echo $_SESSION['nama'];
                ?></h2>
              <h3 class="mb-12"><?php
          ...
          while($row = mysqli_fetch_assoc($dataPaslon)){
            echo '<div class="col-lg-4 col-md-6 mb-4">
                          <div class="card" style="min-height: 500px;">
                            <img class="card-img-top" src="../admin/dashboard/foto-paslon/psdku/'.$row['file_foto'].'" alt="">
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <form action="../includes/pilih.inc.php" method="post">
                                    ...
                                    <input type="hidden" name="idx_vote" value="2">
                                    <input type="hidden" name="sdhvote" value="psdku">
                                </form>
                            </div>
                          </div>
                        </div>';
